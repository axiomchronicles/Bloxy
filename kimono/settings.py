...
SECRET_KEY = "aquilify-insecure-=G0LvV%#bE#JalpuBdar*Dx#PnRB%ewuK@e1QnGqx2x2nBz" # replace with you own strong and secure secret key.
...
DEBUG = False # Disable the DEBUG mode in production usage, due to security measures.
